...
template <typename F, typename... Args>
struct is_invocable<std::void_t<invoke_result_t<F, Args...>>, F, Args...>
    : std::true_type {};
...
struct is_invocable_r<std::void_t<invoke_result_t<F, Args...>>, R, F, Args...>
...
inline constexpr std::size_t find(std::string_view this_, char ch,
                                  std::size_t begin = 0) {
...
template <typename... Ts> inline constexpr bool false_v = false;
...
template <std::size_t I, typename T> struct indexed_type : identity<T> {};

template <std::size_t I>
using size_constant = std::integral_constant<std::size_t, I>;

template <std::size_t N = 0> struct priority : priority<N + 1> {};

template <> struct priority<4> {};
...
template <typename T, typename U>
struct qualify_as<T, U volatile> : lib::identity<qualify_as_t<T, U> volatile> {
};
...
template <typename T> struct aggregate_size_impl {
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<1>) {
    ...
    auto &&[x00] = std::forward<Aggregate>(aggregate);
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<2>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01] = std::forward<Aggregate>(aggregate);
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<3>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02] = std::forward<Aggregate>(aggregate);
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<4>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03] = std::forward<Aggregate>(aggregate);
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<5>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04] = std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04));
}
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<6>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05] = std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05));
}
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<9>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08] =
        std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05), FWD(x06), FWD(x07),
                                 FWD(x08));
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<10>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09] =
        std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05), FWD(x06), FWD(x07),
                                 FWD(x08), FWD(x09));
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<11>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10] =
        std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05), FWD(x06), FWD(x07),
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<12>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11] =
        std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05), FWD(x06), FWD(x07),
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<13>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12] =
        std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(
        FWD(x00), FWD(x01), FWD(x02), FWD(x03), FWD(x04), FWD(x05), FWD(x06),
        FWD(x07), FWD(x08), FWD(x09), FWD(x10), FWD(x11), FWD(x12));
}
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<14>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12,
            x13] = std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(
        FWD(x00), FWD(x01), FWD(x02), FWD(x03), FWD(x04), FWD(x05), FWD(x06),
        FWD(x07), FWD(x08), FWD(x09), FWD(x10), FWD(x11), FWD(x12), FWD(x13));
}
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<15>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12,
            x13, x14] = std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05), FWD(x06), FWD(x07),
                                 FWD(x08), FWD(x09), FWD(x10), FWD(x11),
...
auto as_tuple_impl(Aggregate &&aggregate, lib::size_constant<16>) {
    using T = decltype(std::forward<Aggregate>(aggregate));
    auto &&[x00, x01, x02, x03, x04, x05, x06, x07, x08, x09, x10, x11, x12,
            x13, x14, x15] = std::forward<Aggregate>(aggregate);
    return std::forward_as_tuple(FWD(x00), FWD(x01), FWD(x02), FWD(x03),
                                 FWD(x04), FWD(x05), FWD(x06), FWD(x07),
                                 FWD(x08), FWD(x09), FWD(x10), FWD(x11),
...
template <typename Aggregate> auto as_tuple(Aggregate &&aggregate) {
...
template <typename T> class forwarder {
  private:
    ...
    static constexpr bool enable_explicit() {
        return is_enabled<U, Qualified>() &&
               !std::is_convertible_v<Qualified, T>;
    }
...
template <> class forwarder<void> {
  public:
    ...
    template <typename U> forwarder(forwarder<U> &&) noexcept {}
...
inline constexpr struct no_match_t {
} no_match{};
...
template <typename T> inline constexpr bool is_match_result_v = false;
...
template <typename F, typename Args> auto match_apply(F &&f, Args &&args) {
    return match_apply(
...
template <typename F> struct LazyExpr;

template <typename T> inline constexpr bool is_lazy_expr_v = false;

template <typename F> inline constexpr bool is_lazy_expr_v<LazyExpr<F>> = true;

} // namespace detail

template <std::size_t I, typename Pattern> struct Identifier;

template <typename T> inline constexpr bool is_identifier_v = false;
...
template <std::size_t I, typename T> struct indexed_forwarder : forwarder<T> {
...
template <typename T> inline constexpr bool is_indexed_forwarder_v = false;

template <std::size_t I, typename T>
inline constexpr bool is_indexed_forwarder_v<indexed_forwarder<I, T>> = true;

template <typename Is, typename... Ts> struct set;

template <std::size_t... Is, typename... Ts>
struct set<std::index_sequence<Is...>, Ts...> : lib::indexed_type<Is, Ts>... {};

template <std::size_t I, typename T> struct find_indexed_forwarder;

template <std::size_t I, typename... Ts>
struct find_indexed_forwarder<I, std::tuple<Ts...>> {
    template <std::size_t Idx, typename T>
    static constexpr std::size_t
    impl(lib::indexed_type<Idx, indexed_forwarder<I, T> &&>) {
        return Idx;
    }
    ...
    if constexpr (is_identifier_v<Decayed>) {
        if constexpr (Decayed::has_pattern) {
            ...
            constexpr std::size_t i = find_indexed_forwarder_v<
                Decayed::index, std::tuple<indexed_forwarder<Is, Ts> &&...>>;
...
template <typename Lambda> struct LazyExpr {
#define MPARK_PATTERNS_MEMBER_OPERATORS(type)                                  \
    template <typename Arg> auto operator=(Arg &&arg) const noexcept {         \
        auto lambda = make_lambda(                                             \
            ...
            static_cast<const type &>(*this), std::forward<Arg>(arg));         \
    ...
    auto operator()(Args &&... args) const noexcept {                          \
        auto lambda = make_lambda(                                             \
            ...
            static_cast<const type &>(*this), std::forward<Args>(args)...);    \
        return LazyExpr<decltype(lambda)>{std::move(lambda)};                  \
    }                                                                          \
                                                                               \
    template <typename Arg> auto operator[](Arg &&arg) const noexcept {        \
        auto lambda = make_lambda(                                             \
            [](auto &&this_, auto &&arg_) -> decltype(auto) {                  \
                ...
                if constexpr (std::is_array_v<                                 \
                                  std::remove_reference_t<This_>>) {           \
                    /* For arrays, we handle the forwarding explicitly because \
                     */                                                        \
                    /* `std::forward<T>(t)[I]` always yields an lvalue-ref on  \
                     * GCC. */                                                 \
                    ...
                    return std::forward<This_>(                                \
                        this_)[std::forward<Arg_>(arg_)];                      \
                }                                                              \
            },                                                                 \
            static_cast<const type &>(*this), std::forward<Arg>(arg));         \
        return LazyExpr<decltype(lambda)>{std::move(lambda)};                  \
...
template <std::size_t I, typename Pattern> struct IdentifierBase {
...
struct Identifier<I, void> : detail::IdentifierBase<I, void> {
    ...
    template <typename Arg> auto call(Arg &&arg) const noexcept {
...
constexpr std::tuple<Identifier<Is, void>...>
make_identifiers(std::index_sequence<Is...>) {
    return {Is...};
}

template <std::size_t Bind, std::size_t Discard, std::size_t I,
          typename StrView>
...
auto try_match(const Identifier<I, Pattern> &identifier, Value &&value, F &&f) {
    auto f_ = [&](auto &&... ifs) {
        static_assert((... && lib::is_rref_v<decltype(ifs)>));
        return match_invoke(
            std::forward<F>(f),
    ...
    if constexpr (Identifier<I, Pattern>::has_pattern) {
        return try_match(identifier.arg, std::forward<Value>(value),
                         std::move(f_));
    } else {
        return f_();
    }
...
template <typename Pattern> struct Variadic { const Pattern &pattern; };

template <typename Pattern> auto variadic(const Pattern &pattern) noexcept {
    return Variadic<Pattern>{pattern};
}

template <typename Pattern> inline constexpr bool is_variadic_v = false;
...
template <typename... Patterns> struct Ds {
    std::tuple<const Patterns &...> patterns;
};

template <typename... Patterns> auto ds(const Patterns &... patterns) noexcept {
...
constexpr bool is_tuple_like(lib::priority<0>) noexcept {
    return true;
}

template <typename T> constexpr bool is_tuple_like(lib::priority<1>) noexcept {
    return false;
}
...
template <std::size_t I, typename T>
inline constexpr DetectResult
    detect_get_v = detect_get<I, T>(lib::priority<>{});

template <typename... Patterns, typename Values, typename F>
auto try_match_impl(const Ds<Patterns...> &, Values &&, F &&f,
                    std::index_sequence<>) {
    return match_invoke(std::forward<F>(f));
}

template <typename... Patterns, typename Values, typename F, std::size_t I,
          std::size_t... Is>
auto try_match_impl(const Ds<Patterns...> &ds, Values &&values, F &&f,
...
template <typename... Patterns> constexpr std::size_t find_variadic() {
...
auto try_match(const Ds<Patterns...> &ds, Values &&values, F &&f) {
    ...
    if constexpr (!is_array && !is_tuple_like) {
        ...
        return try_match(ds, detail::as_tuple(std::forward<Values>(values)),
                         std::forward<F>(f));
    } else {
        constexpr auto size = [] {
...
template <std::size_t... Is, typename... Ts, std::size_t J, std::size_t... Js>
...
template <std::size_t P, std::size_t I, std::size_t Q, std::size_t... Is,
          typename... Tail>
auto insert(
    ...
    if constexpr (P == wildcard_index || P == arg_index) {
        return lib::list<Head, Tail...,
                         lib::indexed_type<P, std::index_sequence<I>>>{};
...
auto grouped_indices(lib::list<Ts...>, std::index_sequence<>,
                     std::index_sequence<>) {
    return lib::list<typename Ts::type...>{};
}

template <Pred pred, typename... Ts, std::size_t P, std::size_t... Ps,
          std::size_t I, std::size_t... Is>
auto grouped_indices(lib::list<Ts...> result, std::index_sequence<P, Ps...>,
                     std::index_sequence<I, Is...>) {
    return grouped_indices<pred>(
        ...
        std::index_sequence<Ps...>{}, std::index_sequence<Is...>{});
}
...
using grouped_indices_t = decltype(
    grouped_indices<pred>(lib::list<>{}, std::index_sequence<Ts::index...>{},
                          std::index_sequence_for<Ts...>{}));

template <typename T> inline constexpr std::size_t front_v = npos;

template <std::size_t I, std::size_t... Is>
inline constexpr std::size_t front_v<std::index_sequence<I, Is...>> = I;

template <typename... GroupedIndices>
std::index_sequence<front_v<GroupedIndices>...>
fronts(lib::list<GroupedIndices...>);
...
inline constexpr Pred args_fn = [](std::size_t i) { return i <= arg_index; };

template <typename... Ts>
using args_indices_t = decltype(fronts(grouped_indices_t<args_fn, Ts...>{}));
...
template <typename Pattern, typename Rhs> struct Case {
...
template <bool Guarded, typename...> struct Pattern;

template <bool Guarded, typename... Ts> struct PatternBase {
    using type = Pattern<Guarded, Ts...>;

    static constexpr bool guarded = Guarded;

    template <typename Rhs> auto operator=(Rhs &&rhs) && noexcept {
...
struct Pattern<false, Patterns...> : PatternBase<false, Patterns...> {
    ...
    template <typename Arg> auto when(Arg &&arg) && noexcept {
...
template <typename R, typename... Values> struct Match {
  public:
    ...
    decltype(auto) operator()(Case<Pattern, Rhs> &&case_,
        ...
        auto result = [&] {
            auto result = try_match(
                std::move(case_).pattern.patterns, std::move(values),
                [&](auto &&... ifs_) {
                    // The intermediate function that performs the adjustments
                    // for placeholder-related functionality and ultimately
                    // calls `f` with the final arguments.
                    static_assert((... && lib::is_rref_v<decltype(ifs_)>));
                    auto ifs = std::forward_as_tuple(std::move(ifs_)...);

                    auto invoke = [&](auto invoke_, auto &&f) {
                        if constexpr (is_lazy_expr_v<
                                          std::decay_t<decltype(f)>>) {
                            return lib::apply(
                                [&](auto &&... ifs_) -> decltype(auto) {
                                    // We already checked for rvalue-reference
                                    // above.
                                    return invoke_(
...
template <typename... Patterns> struct Anyof {
    std::tuple<const Patterns &...> patterns;
};
...
auto try_match_impl(const Anyof<Patterns...> &anyof, Value &&value, F &&f,
                    std::index_sequence<I>) {
    return try_match(std::get<I>(anyof.patterns), std::forward<Value>(value),
                     [&](auto &&... args) {
                         return match_invoke(
                             std::forward<F>(f),
                             std::forward<decltype(args)>(args)...);
...
auto try_match_impl(const Anyof<Patterns...> &anyof, Value &&value, F &&f,
    ...
    auto result = try_match(std::get<I>(anyof.patterns),
                            std::forward<Value>(value), [&](auto &&... args) {
                                return match_invoke(
                                    std::forward<F>(f),
                                    std::forward<decltype(args)>(args)...);
                            });
    return result ? std::move(result)
                  : try_match_impl(anyof, std::forward<Value>(value),
                                   std::forward<F>(f),
                                   std::index_sequence<J, Js...>{});
}
...
auto try_match(const Anyof<Patterns...> &anyof, Value &&value, F &&f) {
    return detail::try_match_impl(anyof, std::forward<Value>(value),
                                  std::forward<F>(f),
...
template <typename T, typename V>
inline constexpr DetectResult
    detect_get_if_v = detect_get_if<T, V>(lib::priority<>{});
...
template <typename T, typename V>
inline constexpr DetectResult
    detect_any_cast_v = detect_any_cast<T, V>(lib::priority<>{});

} // namespace detail

template <typename T, typename Pattern> struct As { const Pattern &pattern; };

template <typename T, typename Pattern>
auto as(const Pattern &pattern) noexcept {
    return As<T, Pattern>{pattern};
}

template <typename T, std::enable_if_t<std::is_class_v<T>, int> = 0,
          std::size_t = sizeof(std::variant_size<T>)>
constexpr bool is_variant_like(lib::priority<0>) noexcept {
    return true;
}

template <typename T>
constexpr bool is_variant_like(lib::priority<1>) noexcept {
    return false;
}

template <typename T>
inline constexpr bool is_variant_like_v = is_variant_like<T>(lib::priority<>{});
...
template <typename Pattern, typename Value> struct IfLet {
    template <typename F> void operator=(F &&f) && noexcept {
        match<void>(std::move(case_).rhs())(
            std::move(case_).pattern = std::forward<F>(f), pattern(_) = [] {});
    }
...
template <typename Pattern, typename Value> struct ForLet {
    template <typename F> void operator=(F &&f) && noexcept {
        for (auto &&elem : std::move(case_).rhs()) {
            ControlFlow control_flow = match(
                std::forward<decltype(elem)>(elem))(
                std::move(case_).pattern =
                    [&](auto &&... args) {
...
template <typename Pattern> struct Some { const Pattern &pattern; };

template <typename Pattern> auto some(const Pattern &pattern) {
...
template <typename RegexF> struct Regex { std::regex regex; };
...
template <typename RegexF, typename Value, typename F,
