...
%token KW_FOR KW_IF KW_ELSE KW_WHILE KW_DO KW_RETURN KW_BREAK KW_CONTINUE KW_CASE KW_STRUCT KW_USE
...
GlobalDeclDef:
    KW_USE IDENTIFIER DELIM_SEMICOLON {
        $$ = Token("LibraryUse", $2, @2);
